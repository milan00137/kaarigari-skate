...
import { SkateboardModel } from '@/app/components/SkateBoards';
...
type Props = {
  deskTextureURL: string,
  wheelTextureURL: string,
  truckColor: string,
  boltColor: string,
}

export function InteractiveSkateboard({ deskTextureURL, wheelTextureURL, truckColor, boltColor }: Props) {
  return (
...
function Scene({ deskTextureURL, wheelTextureURL, truckColor, boltColor }: Props) {
        ...
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            <SkateboardModel
              ...
              wheelTextureURL={wheelTextureURL}
              deckTextureURLs={[deskTextureURL]}
              deckTextureURL={deskTextureURL}
              truckColor={truckColor}
              boltColor={boltColor}
              constantWheelSpin
            //  pose='side'
