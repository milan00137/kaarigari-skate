...
export async function SkateboardProduct({id}: Props) {
    ...
    const dominantColor = isFilled.image(product.data.image) ? await getDominantColor(product.data.image.url): "#f00";
  ...
  return (
    <div className='group relative mx-auto w-full max-w-72 px-8 pt-4'>
        ...
        <div className='flex items-center justify-between ~text-sm/2xl'>
            ...
            <span className="inline-flex items-center gap-1"><FaStar className='text-yellow-400'/>37</span>
        </div>
