...
interface SkaterDocumentData {
  ...
  /**
   * Photo foregraound field in *Skater*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.photo_foregraound
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  photo_foregraound: prismic.ImageField<never>;
...
export interface TextAndImageSliceDefaultPrimary {
  ...
  /**
   * Backdround Image field in *TextAndImage → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.default.primary.backdround_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  backdround_image: prismic.ImageField<never>;
...
export interface TextAndImageSliceImageOnLeftPrimary {
  ...
  /**
   * Backdround Image field in *TextAndImage → Image on Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLeft.primary.backdround_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  backdround_image: prismic.ImageField<never>;
